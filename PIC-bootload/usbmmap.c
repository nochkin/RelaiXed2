...
volatile byte usb_device_state;          // Device States: DETACHED, ATTACHED, ...
volatile USB_DEVICE_STATUS usb_stat;     // Global USB flags
...
#if(0 <= MAX_EP_NUMBER)
volatile BDT ep0Bo @ 0x400;         //Endpoint #0 BD Out
volatile BDT ep0Bi @ 0x404;         //Endpoint #0 BD In
#endif

#if(1 <= MAX_EP_NUMBER)
volatile BDT ep1Bo @ 0x408;         //Endpoint #1 BD Out
volatile BDT ep1Bi @ 0x40c;         //Endpoint #1 BD In
#endif
...
#if(5 <= MAX_EP_NUMBER)
volatile BDT ep5Bo;         //Endpoint #5 BD Out
volatile BDT ep5Bi;         //Endpoint #5 BD In
#endif

#if(6 <= MAX_EP_NUMBER)
volatile BDT ep6Bo;         //Endpoint #6 BD Out
volatile BDT ep6Bi;         //Endpoint #6 BD In
#endif

#if(7 <= MAX_EP_NUMBER)
volatile BDT ep7Bo;         //Endpoint #7 BD Out
volatile BDT ep7Bi;         //Endpoint #7 BD In
#endif

#if(8 <= MAX_EP_NUMBER)
volatile BDT ep8Bo;         //Endpoint #8 BD Out
volatile BDT ep8Bi;         //Endpoint #8 BD In
#endif

#if(9 <= MAX_EP_NUMBER)
volatile BDT ep9Bo;         //Endpoint #9 BD Out
volatile BDT ep9Bi;         //Endpoint #9 BD In
#endif

#if(10 <= MAX_EP_NUMBER)
volatil BDT ep10Bo;        //Endpoint #10 BD Out
volatile BDT ep10Bi;        //Endpoint #10 BD In
#endif

#if(11 <= MAX_EP_NUMBER)
volatile BDT ep11Bo;        //Endpoint #11 BD Out
volatile BDT ep11Bi;        //Endpoint #11 BD In
#endif

#if(12 <= MAX_EP_NUMBER)
volatile BDT ep12Bo;        //Endpoint #12 BD Out
volatile BDT ep12Bi;        //Endpoint #12 BD In
#endif

#if(13 <= MAX_EP_NUMBER)
volatile BDT ep13Bo;        //Endpoint #13 BD Out
volatile BDT ep13Bi;        //Endpoint #13 BD In
#endif

#if(14 <= MAX_EP_NUMBER)
volatile BDT ep14Bo;        //Endpoint #14 BD Out
volatile BDT ep14Bi;        //Endpoint #14 BD In
#endif

#if(15 <= MAX_EP_NUMBER)
volatile BDT ep15Bo;        //Endpoint #15 BD Out
volatile BDT ep15Bi;        //Endpoint #15 BD In
#endif
